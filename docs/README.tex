...
\item part, h2, heading or chapter\footnote{Chapter is not available in standard template as it is not available in the document class used.}\xspace  for part, chapter / <h2>
