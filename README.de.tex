...
Die Hintergrundfarbe eines Absatzes kann über den Parameter \textcolor{PaleTurquoise1}{Hintergrund} gesetzt werden; die Textfarbe über \textcolor{PaleTurquoise1}{Farbe}. Um in einem Absatz einzelne Wörter oder einen Bereich farbig zu gestalten, können analog die Schlüsselwörter \textcolor{PaleTurquoise1}{Farbe} und \textcolor{PaleTurquoise1}{Hintergrund} verwendet werden.
}}
}
